...
public class Shell {
     ...
     */
    public func session(user: String = NSUserName(), hostname: String = ProcessInfo().hostName, uuid: String = UUID().uuidString, completion: @escaping (_ exists: Bool, _ session: ShellSession) -> Void) {
